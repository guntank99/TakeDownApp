...
export default function NotFound() {
  return (
    <div role="status" className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-slate-700 px-6 py-14 text-center">
      ...
      <p className="text-sm text-slate-300">That record was not found.</p>
      <Link href="/dashboard" className="text-sm text-sky-400 hover:underline">Back to dashboard</Link>
    </div>
  );
}
